...
export const deleteRoadmapAction = async (id: number) => {
    try {
        ...
        if (!resp.ok) {
            return {
                ok: false as const,
                msg: nestMsg(body, "Error al eliminar el roadmap"),
            };
        }
        ...
        return { ok: false as const, msg: "Error al eliminar el roadmap" };
    }
};
